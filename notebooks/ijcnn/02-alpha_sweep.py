...
alphas = np.linspace(0.0, 1.0, 10, endpoint=True)
num_runs = 10
...
plt.tight_layout()
plt.savefig(script_dir / config['output_dir'] / f"whitenoise_sweep_k_{distribution_name}.png", dpi=300)
...
plt.tight_layout()
plt.savefig(script_dir / config['output_dir'] / f"whitenoise_sweep_alpha_{distribution_name}.png", dpi=300)
